                ...
                <div class="block">
                    <form class="block__category category-form" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="category-form__row">
                            ...
                            <input type="text" name="title" @error('title')  @enderror
                                value="@isset($product) {{ $product->title }}@else {{ old('title') }} @endisset">
                        </div>
                        ...
                        <div class="category-form__row">
                            ...
                            <input type="file" class="file" name="photo" @error('photo')  @enderror
                                value="{{ old('photo') }}">
                        </div>
                        @include('admin.error.error', ['fieldName' => 'photo'])
                        <div class="category-form__row">
                            <label for="description">Опис продукту:</label>
                            <input type="text" name="description" @error('description')  @enderror
                                value="@isset($product) {{ $product->description }}@else {{ old('description') }} @endisset">
                        </div>
                        @include('admin.error.error', ['fieldName' => 'description'])
                        <div class="category-form__row">
                            <label for="weight">Вага продукту:</label>
                            <input type="text" name="weight" @error('weight')  @enderror
                                value="@isset($product) {{ $product->weight }}@else {{ old('weight') }} @endisset">
                        </div>
                        @include('admin.error.error', ['fieldName' => 'weight'])
                        <div class="category-form__row">
                            <label for="price">Ціна продукту:</label>
                            <input type="text" name="price" @error('price')  @enderror
                                value="@isset($product) {{ $product->price }}@else {{ old('price') }} @endisset">
                        </div>
                        @include('admin.error.error', ['fieldName' => 'price'])
                        <div class="category-form__row">
                            @isset($product)
